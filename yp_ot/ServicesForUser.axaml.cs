...
public partial class ServicesForUser : Window
{
    ...
    private void ShowTable(object fullTable)
    {
        ...
        public void ShowTable(string sql)
        {
            ...
            while (reader.Read() && reader.HasRows)
            {
                var Serv = new Услуги()
                {
                    ...
                    Цена_со_скидкой = reader.GetInt32("Стоимость") -
                                      (reader.GetInt32("Стоимость") * reader.GetInt32("Скидка") / 100)
                };
                _услугис.Add(Serv);
            }
        ...
        {
            RecordUser logout = new RecordUser();
            logout.Show();
            this.Close();
        }
